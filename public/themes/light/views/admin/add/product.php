...
<div class="section">
	...
	<h4 class="page-title-bold mb-3 mt-0">Add a Product</h4>
	...
	<div class="row" style="padding: 1em; background-color: rgba(0,100,200,0.3);">
			...
			<div class="col-12" style="padding-left:0;">
				...
				<div class="alert alert-warning form-return mb-4">
					<i class="fa fa-exclamation-circle mr-1"></i> It looks like another product(s) has been found with the same or similar name:
					<div class="the-found">
					</div>
				</div>
				...
				<div class="custom-button add_product_submit" style="margin-left:0;">Add</div>
			</div>
